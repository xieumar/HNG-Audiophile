...
function About() {
  return (
    <div className="bg-(--white-light) lg:px-[100px] px-[50px]">
        <div className="mx-auto max-w-[1110px]  flex flex-col-reverse lg:flex-row pb-[100px] lg:pb-[150px]">
             <div className="w-full md:w-full  flex flex-col gap-6 items-center md:items-center justify-center text-center md:text-center lg:items-start lg:text-left md:mt-10">
             ...
             <picture className='rounded-lg w-full md:w-full mt-8 md:mt-0'>
